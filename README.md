## object_msgs (crystal) - 0.3.0-2

The packages in the `object_msgs` repository were released into the `crystal` distro by running `/usr/local/bin/bloom-release --rosdistro crystal --track crystal object_msgs` on `Fri, 14 Dec 2018 06:36:22 -0000`
